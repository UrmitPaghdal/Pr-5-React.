...
const Popular = () => {
  ...
  <div className="card-body">   
    ...
    <a href="#">$120.25</a>
                    ...
                    <div className="col-sm-12 col-md-6 col-lg-3">
                    <div className="card  mx-auto" style={{width: '18rem'}}>
  <img src="public/img/9.jpeg" className="card-img-top" alt="..." />
  <div className="card-body">   
  ...
  <div className="card-body">   
    ...
    <a href="#">$120.25</a>
                    ...
                    <div className="col-sm-12 col-md-6 col-lg-3 ">
                    <div className="card mx-auto" style={{width: '18rem'}}>
  <img src="public/img/17.jpeg" className="card-img-top" alt="..." />
  <div className="card-body">   
  ...
  <div className="card-body">   
    ...
    <a href="#">$120.25</a>
                    ...
                    <div className="col-12 col-md-6  col-lg-3 ">
                    <div className="card mx-auto" style={{width: '18rem'}}>
  <img src="public/img/36.jpeg" className="card-img-top" alt="..." />
  <div className="card-body">   
    <h6 className="card-title">Fruits</h6>
    <div className="d-flex opp">
    <FaStar />
    ...
    <p className="card-text">Organic fresh venila farm
                                        watermelon 5kg</p>
    <a href="#">$50.30</a>
                    ...
                    <div className="col-12 col-md-6  col-lg-3 ">
                    <div className="card mx-auto" style={{width: '18rem'}}>
  <img src="public/img/10.jpeg" className="card-img-top" alt="..." />
  <div className="card-body">   
    <h6 className="card-title">Snacks</h6>
    <div className="d-flex opp">
    <FaStar />
